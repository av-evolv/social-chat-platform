...
Upstream source and advisory URLs were checked on the decision date. Root repository CI continues to cover the existing platform; the isolated Rust/browser spike is explicitly run using the commands above and is not yet part of required CI.
